    ...
    <div className="w-[calc(33%-74px)] bg-background-gray px-4 py-2 rounded-md border-2 border-gray mb-12">
      <div className="description flex flex-col gap-2">
        <span className="font-bold text-sm">
          {unit.opened ? (
            <span className="text-yellow">Aberto</span>
          ) : (
            <span className="text-red">Fechado</span>
          )}
        </span>
      ...
      {unit.opened && (
        <>
          ...
          <div className="information-cards flex flex-wrap justify-between gap-2 mb-4">
            <Image
              src={`/img/information-card/${unit.mask}-mask.png`}
              height="58"
              width="58"
              alt="Máscara"
            />
            <Image
              src={`/img/information-card/${unit.towel}-towel.png`}
              height="58"
              width="58"
              alt="Toalha"
            />
            <Image
              src={`/img/information-card/${unit.fountain}-fountain.png`}
              height="58"
              width="58"
              alt="Garrafa de Água"
            />
            <Image
              src={`/img/information-card/${unit.locker_room}-lockerroom.png`}
              height="58"
              width="58"
              alt="Vestiário"
            />
